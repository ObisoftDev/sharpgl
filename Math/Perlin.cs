...
namespace SharpGL
{
    public class Perlin
    {
        ...
        public static float grad(int hash, double x, double y, double z)
        {
            ...
            return (float)(((h & 1) == 0 ? u : -u) + ((h & 2) == 0 ? v : -v)); // Use the last 2 bits to decide if u and v are positive or negative.  Then return their addition.
        }
        ...
        public static float lerp(double a, double b, double x)
        {
