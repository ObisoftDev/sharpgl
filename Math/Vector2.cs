...
namespace SharpGL
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        public static Vector2 Normalize(Vector2 v)
        {
            ...
            return new Vector2(v.X * invDiv, v.Y * invDiv);
        }
        ...
        public static Vector2 Lerp(Vector2 a, Vector2 b, float amountx, float amounty)
        {
            return new Vector2(a.X + (b.X - a.X) * amountx, a.Y + (b.Y - a.Y) * amounty);
        }
    }
