...
namespace SharpGL.Graphics
{
    public class ShaderProgram
    {
            ...
            Dictionary<uint, string> attributeLocations)
        {
            ...
            GL.ValidateProgram(this.ShaderProgramObject);
        ...
        {
            GL.Uniform2(this.GetUniformLocation(uniformName), v.X, v.Y);
        }
        /// <summary>
        ...
        {
            GL.Uniform3(this.GetUniformLocation(uniformName), v.X, v.Y, v.Z);
        }
        /// <summary>
        ...
        {
            GL.Uniform4(this.GetUniformLocation(uniformName), v.X, v.Y, v.Z, v.W);
        }
        /// <summary>
        ...
        {
            GL.UniformMatrix4(this.GetUniformLocation(uniformName), 1, false, matrix.ToFloat());
        }
        /// <summary>
