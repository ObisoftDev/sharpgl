...
namespace SharpGL.Graphics
{
    public static partial class GL
    {
        ...
        public static void BufferData(BufferTarget target, int byteLength, IntPtr data, BufferUsageHint usage)
        {
            _glBufferData((uint)target, byteLength, data, (uint)usage);
        }
        public static void BufferData(BufferTarget target, int byteLength, float[] data, BufferUsageHint usage)
        {
            GCHandle gc = GCHandle.Alloc(data, GCHandleType.Pinned);
            BufferData(target, byteLength, gc.AddrOfPinnedObject(), usage);
        }
        public static void BufferData(BufferTarget target, int byteLength, int[] data, BufferUsageHint usage)
        {
            GCHandle gc = GCHandle.Alloc(data,GCHandleType.Pinned);
            BufferData(target, byteLength, gc.AddrOfPinnedObject(), usage);
        }
        ...
        public static void DrawElements(PrimitiveType mode,int count,DrawElementsType elementType,uint indices,int primCount=1)
        {
            DrawElementsInstanced((uint)mode, count, (uint)elementType,(IntPtr)indices, primCount);
        }
        ...
        public delegate void glDrawElements(uint mode, uint count, uint elementType, uint indices);
        ...
        public static void DeleteVertexArray(uint vertex)
        {
            DeleteVertexArrays(1, new uint[] { vertex });
        }
